...
**Day-1 — extend existing TPRM to AI vendors.** Like [[enterprise-grc]], a regulated
...
point. Closely related but distinct from [[software-supply-chain]] (code/dependency
provenance) and [[non-human-identity]] (machine credentials for those vendors' agents).
...
- [[processunity]] — TPRM assessment + workflow platform (vendor onboarding, questionnaires, lifecycle).
- [[securityscorecard]] — outside-in cyber ratings; continuous external security scoring.
- [[bitsight]] — outside-in cyber ratings; large ratings dataset, common benchmark.
- [[black-kite]] — cyber ratings with financial-impact and ransomware-susceptibility framing.
- [[upguard]] — cyber ratings + attack-surface / vendor monitoring, lighter-weight.
...
- [[enterprise-grc]] — TPRM is frequently a module of the same GRC suite; the vendor register lives there.
- [[software-supply-chain]] — code/dependency provenance, the engineering-side cousin of vendor risk.
- [[ai-governance-platform]] — vendor/model risk feeds the broader AI risk register.
- [[non-human-identity]] — once a vendor's agents are in your environment, they need governed machine identities.
...
[[enterprise-grc]] tool (ServiceNow, Archer, OneTrust) rather than a dedicated
...
- Overlap with [[enterprise-grc]]: TPRM as a module vs a standalone tool. Survey
  should capture both.
