...
runtime tools ([[ai-runtime-security]], [[llm-observability]], [[ai-access-governance]])
feed evidence into.
...
inventory in a spreadsheet or [[enterprise-grc]] tool, the question is whether AI use
...
- [[credo-ai]] — AI governance and registry; policy packs mapped to NIST AI RMF / EU AI Act.
- [[holistic-ai]] — AI governance, risk, and auditing; bias/robustness assessment lean.
- [[modelop]] — model lifecycle governance with deep roots in traditional MRM/SR 11-7 model inventory.
- [[monitaur]] — model governance and assurance aimed at regulated (esp. insurance/financial) use.
- [[fairly-ai]] — AI governance and compliance automation; policy-as-checklist framing.
- [[ibm-watsonx-governance]] — governance module of the watsonx stack; lifecycle + risk dashboards.
- [[governgpt]] — AI governance / due-diligence automation (positioning TBD on depth).
- [[cranium]] — AI security + governance posture; inventory of AI assets and supply chain.

Adjacent platforms that also carry an AI-governance module (cross-listed):

- [[onetrust]] — privacy/GRC suite with an AI governance module; strong if you already own OneTrust.
- [[vanta]] — compliance automation (SOC 2, ISO) extending into AI governance / ISO 42001.
- [[securiti]] — data + AI governance, anchored in DSPM and data lineage.
- [[collibra]] — data governance/catalog extending to AI/model registry.
- [[calypsoai]] — runtime AI security vendor with governance/reporting framing (per seed; acq. by F5 — unverified).

Observability vendors with governance reporting also overlap here: [[fiddler-ai]],
[[arthur-ai]].
...
Collibra, Vanta). [[calypsoai]] is flagged as acquired by F5 (per seed; unverified —
...
- [[enterprise-grc]] — the general system of record for risk/controls; AI governance is often a module inside it rather than a separate tool.
- [[llm-observability]] — supplies the runtime evaluation/monitoring evidence that proves controls work.
- [[ai-spm]] — discovers and inventories AI assets/agents; feeds the governance inventory.
- [[ai-runtime-security]] — the enforcement layer whose policies governance attests to.
- [[comms-surveillance]] — a parallel governance/detective discipline specific to MAR/MNPI.
...
**Notes for survey design.** Heavy overlap with [[enterprise-grc]]: many respondents
...
- Where is the line between this and [[enterprise-grc]]? For many firms AI governance
  is a GRC module, not a separate product — the survey must let respondents say so.
- [[ai-spm]] (discovery/inventory of AI assets) vs governance platform (risk mapping
  + attestation) overlap on "AI inventory." Worth a comparison page.
- Observability vendors (Fiddler, Arthur) straddle [[llm-observability]] and
