...
It is the place you *attach* the security ([[ai-runtime-security]]) and visibility
([[llm-observability]]) controls, because it's the one point every model call must
cross.
...
control, and for the audit log that compliance and [[comms-surveillance]] will later
...
purposes downstream. If you only use a vendor-hosted [[enterprise-ai-assistant]],
...
([[ai-runtime-security]]) onto it. It typically sits at the boundary of the
...
Palo Alto Networks; F5 flagged as having acquired [[calypsoai]] (pairing a gateway
