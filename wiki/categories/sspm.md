...
- [appomni](../vendors/appomni.md) — SSPM pioneer; broad app coverage and deep posture/data-exposure analysis.
- [obsidian-security](../vendors/obsidian-security.md) — SSPM with strong threat-detection/ITDR emphasis across SaaS.
- [adaptive-shield](../vendors/adaptive-shield.md) — SSPM with SaaS misconfiguration and identity-posture focus.
- [grip-security](../vendors/grip-security.md) — SaaS/identity discovery and shadow-SaaS (and shadow-AI) governance.
- [valence-security](../vendors/valence-security.md) — SSPM emphasizing SaaS-to-SaaS integration and supply-chain risk.
- [wing-security](../vendors/wing-security.md) — SSPM with automated remediation and SaaS-app discovery.
- [docontrol](../vendors/docontrol.md) — SaaS data-access security and DLP-style controls for SaaS.

## Consolidation / M&A dynamics

SSPM is consolidating into larger security platforms. [adaptive-shield](../vendors/adaptive-shield.md) is
...
blurring the line with [ai-access-governance](ai-access-governance.md) and [ai-spm](ai-spm.md). Expect further
roll-up as posture management converges with broader CNAPP/identity platforms.

## Adjacent categories

- [ai-access-governance](ai-access-governance.md) — shadow-AI discovery overlaps with SSPM's shadow-SaaS discovery; some vendors ([grip-security](../vendors/grip-security.md), [reco](../vendors/reco.md), [nudge-security](../vendors/nudge-security.md)) span both.
- [ai-spm](ai-spm.md) — AI-asset/agent posture; conceptually SSPM's AI-native sibling.
- [data-access-governance](data-access-governance.md) — who-can-see-what inside the data; SSPM looks at the SaaS-config layer above it.
- [identity-governance](identity-governance.md) — over-broad SaaS permissions are the joint concern.
...
shadow-AI tools ([grip-security](../vendors/grip-security.md), [reco](../vendors/reco.md), [nudge-security](../vendors/nudge-security.md)) will confuse some
...
- Boundary with [ai-access-governance](ai-access-governance.md) and [ai-spm](ai-spm.md) is fuzzy — shadow-SaaS vs
