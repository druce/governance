...
**Where it sits in the stack** — The [[llm-observability]] layer of the AI model/prompt tier. This is a development- and operations-time visibility tool, not an inline control: it does not by itself break any leg of the lethal trifecta (untrusted input / sensitive data / egress), though traces help you detect prompt-injection or data-leak incidents after the fact. Lives alongside (and downstream of) the [[ai-gateway]] and [[ai-runtime-security]] controls.
