...
ownership_detail: "Private/VC-backed (Series G extended to $409M, 2025). Acquirer of [[aim-security]] — announced 2025-09-03 (~$350M reported), Cato's first acquisition"
...
Primary [[network-security-sase]] (Foundation layer — the TLS-inspecting man-in-the-middle that everything else rides on) with a secondary [[ai-spm]] tag from the Aim acquisition. Lethal-trifecta role: as the inline SASE chokepoint it can touch all three legs — inspecting **untrusted input**, blocking **sensitive-data** egress (DLP/CASB), and controlling **egress** to AI services. Sits at the green↔red boundary for the whole enterprise.
