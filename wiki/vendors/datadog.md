...
**Where it sits in the stack** — The [[llm-observability]] layer of the model/prompt tier. Mostly dev/ops visibility, but its built-in sensitive-data scanning and safety evals give it a light touch on the **sensitive-data** leg of the lethal trifecta (detecting leakage in prompts/outputs). Not an inline firewall — complements [[ai-runtime-security]] and [[ai-gateway]].
