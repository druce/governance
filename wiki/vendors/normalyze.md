...
**Categories** — [dspm](../categories/dspm.md)
...
Data layer, [dspm](../categories/dspm.md). Lethal-trifecta leg: **sensitive-data** — find and reduce sensitive-data exposure before AI systems can reach it. Posture/visibility, not an inline runtime control. Adjacent to [dlp](../categories/dlp.md) (Proofpoint's core) and [data-access-governance](../categories/data-access-governance.md).
...
Known for in-place scanning and quantified risk ("data risk in dollars"). Nearest neighbors: [cyera](cyera.md), [sentra](sentra.md), [bigid](bigid.md), [securiti](securiti.md), [concentric-ai](concentric-ai.md), [bedrock-security](bedrock-security.md), and [wiz](wiz.md) (DSPM-as-CNAPP-module). As part of Proofpoint, the pitch shifts from standalone DSPM to "DSPM + DLP + human-centric security" in one platform.
...
[cyera](cyera.md), [sentra](sentra.md), [bigid](bigid.md), [securiti](securiti.md), [concentric-ai](concentric-ai.md), [bedrock-security](bedrock-security.md), [wiz](wiz.md), [microsoft-purview](microsoft-purview.md).
