...
> Primary category: [[ai-access-governance]]. Independent, venture-backed (~$26M).
...
Sits in [[ai-access-governance]] at the **model-prompt** layer — the control point between the employee/endpoint and the external AI service. Lethal-trifecta role: it primarily breaks the **sensitive-data** and **egress** legs — it inspects and blocks sensitive data from being exfiltrated into untrusted AI apps. It does not by itself harden the model against malicious untrusted input. Trust-zone relevance: it polices the boundary from the green/internal zone out to the red/untrusted-SaaS zone.
...
- [[witnessai]] — also AI access governance, but more network/inline-proxy and policy-gateway oriented; Harmonic leans endpoint/browser + ML detection.
- [[prompt-security]] — runtime AI firewall / prompt-layer security (now part of Palo Alto); more focused on protecting AI apps you build/run, vs Harmonic's employee-usage DLP.
- [[wald-ai]], [[aurascape]], [[lanai]] — overlapping shadow-AI discovery + data-protection plays; differentiation is mostly detection approach and enforcement point.
- [[nudge-security]] — SaaS/AI discovery and user "nudge" workflows, lighter on inline data inspection.
- [[cyberhaven]] — data-lineage/DLP that has moved into AI/insider-risk; broader DLP scope vs Harmonic's AI-usage focus.
- [[reco]] — SaaS security posture / AI app discovery, more posture-than-inline.
...
[[witnessai]], [[prompt-security]], [[wald-ai]], [[aurascape]], [[lanai]], [[nudge-security]], [[cyberhaven]], [[reco]]
