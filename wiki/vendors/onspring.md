...
ownership_detail: "Privately held; minority growth investment from Capital IP Investment Partners. No control acquisition found."
ownership_confidence: medium
funding_total:
last_funding: "Growth/PE minority investment (Capital IP); terms undisclosed"
deployment: [saas]
...
tags: [grc, no-code, risk-management, compliance]
---
...
## Sources
- [Onspring company site](https://onspring.com/) — fetched 2026-06-28 — supports: GRC/no-code scope, Overland Park HQ; confidence: med (vendor)
- [Onspring Crunchbase profile](https://www.crunchbase.com/organization/onspring-technologies) — fetched 2026-06-28 — supports: founded 2010, private, Capital IP investment; confidence: med

## History
- [2026-06-28] Stub created from seed registry.
- [2026-06-28] Researched; confirmed independent/private (minority growth investment, Capital IP); founded 2010 Overland Park; ownership unchanged (independent), confidence medium.
