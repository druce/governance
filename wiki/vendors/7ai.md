...
**Where it sits in the stack** — [[ai-soc-analysts]], Foundation layer; an autonomous automation layer over [[siem-soc]] and [[edr-xdr]]. SOC-ops tooling, not an AI-application guardrail — trifecta_relevance: none. Trusted security-ops zone.
...
**Competitors / alternatives** — [[prophet-security]], [[dropzone-ai]], [[radiant-security]], [[simbian]], [[torq]].
