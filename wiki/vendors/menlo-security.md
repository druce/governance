...
- **[[island]]** and **[[prisma-access-browser]]** ship a managed local Chromium browser; Menlo leans on **cloud isolation** and can secure the user's existing browser without a new install.
- **[[layerx]]** and other [[browser-security-extension]] vendors add controls via extension; Menlo's isolation puts a network/cloud air-gap between user and content.
- **[[seraphic]]** (now CrowdStrike) and **[[red-access]]** are lighter, browser-agnostic plays.
- **[[chrome-enterprise]]** / **[[microsoft-edge-business]]** are the native, lower-cost baselines.
