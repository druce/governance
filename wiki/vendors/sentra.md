...
**Where it sits in the stack** — Primary: [[dspm]]; also [[data-access-governance]]. Data layer. Lethal-trifecta role: the **sensitive-data** leg (discover/classify/constrain) and helping the **egress** leg by keeping sensitive data out of prompts/training. Trust zones: green/yellow cloud data plane feeding AI.
...
**Competitors / alternatives** — [[cyera]], [[bigid]], [[securiti]], [[concentric-ai]], [[microsoft-purview]], Varonis.
