...
The [[identity-governance]] foundation (IGA/ISPM), and [[data-access-governance]] for files/data. It addresses the **sensitive-data** leg of the lethal trifecta by controlling and attesting *who can reach what* — the entitlement substrate that AI assistants and [[entitlement-aware-rag]] must inherit so an LLM never surfaces data the user can't see.
