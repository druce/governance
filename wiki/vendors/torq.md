...
**Where it sits in the stack** — Primary [[ai-soc-analysts]]; also tagged [[siem-soc]] (it's the SOAR/automation layer many SOCs run alongside the SIEM) and [[ai-spm]]. SOC-ops tooling — trifecta_relevance: none. Trusted security-ops zone.
...
**Competitors / alternatives** — [[prophet-security]], [[dropzone-ai]], [[7ai]], [[radiant-security]], [[simbian]]; incumbent SOAR/automation from [[splunk]] (SOAR) and [[palo-alto-networks]] (Cortex XSOAR/XSIAM).
