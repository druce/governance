...
**Where it sits in the stack** — [[policy-as-code]], governance layer. Lethal-trifecta role: indirect/meta — it governs the Kubernetes substrate, enforcing the cluster-level controls behind [[trust-zone-segmentation]] and [[promotion-gates]]. Not in the prompt/data path.
