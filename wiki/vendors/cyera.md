...
**Where it sits in the stack** — Primary: [dspm](../categories/dspm.md); also [data-access-governance](../categories/data-access-governance.md) and [dlp](../categories/dlp.md). Data layer. Lethal-trifecta role: the **sensitive-data** leg (find/classify/constrain) and, via DLP, the **egress** leg (prevent sensitive data leaving to AI/third parties). Trust zones: governs the green/yellow data plane that feeds AI.
...
**Positioning & differentiators** — The category's momentum leader by funding/valuation and Fortune 500 logo count; differentiates on speed-to-value (agentless), classification accuracy, and the DSPM+DLP+identity convergence story. Versus [bigid](bigid.md) (broader data-governance/privacy heritage, on-prem heavy, more config) Cyera is leaner and cloud-native. Versus [sentra](sentra.md) it's the larger, better-capitalized direct rival with a near-identical agentless cloud DSPM pitch. Versus [microsoft-purview](microsoft-purview.md) it spans well beyond the Microsoft estate — and Purview lists Cyera as an integration partner. Versus [concentric-ai](concentric-ai.md) it's broader/enterprise-scale rather than autonomous-unstructured-focused.
