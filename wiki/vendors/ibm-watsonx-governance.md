...
**Competitors / alternatives** — [credo-ai](credo-ai.md), [holistic-ai](holistic-ai.md), [modelop](modelop.md), [monitaur](monitaur.md); cloud-native ML governance (AWS SageMaker model governance, Azure ML) for single-cloud shops; existing GRC platforms for organizations that treat AI risk as an extension of enterprise risk.
