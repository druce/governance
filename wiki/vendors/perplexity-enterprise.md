...
> Researched 2026-06-28. Primary category: [enterprise-ai-assistant](../categories/enterprise-ai-assistant.md).
...
Note the center of gravity differs from [openai-chatgpt-enterprise](openai-chatgpt-enterprise.md) / [anthropic-claude-enterprise](anthropic-claude-enterprise.md): Perplexity leads with **external web research and citations**, not general-purpose chat or coding. Internal-knowledge RAG is a newer add-on, not the core.

## Where it sits in the stack
- Category: [enterprise-ai-assistant](../categories/enterprise-ai-assistant.md) (UX layer) — the chatbot end-users actually touch.
...
- It is a consumer of, not a substitute for, perimeter controls like an [ai-gateway](../categories/ai-gateway.md), [ai-access-governance](../categories/ai-access-governance.md) (shadow-AI / CASB-for-AI), and [dlp](../categories/dlp.md). A fund would typically still want shadow-AI discovery to see who's using the *consumer* Perplexity vs. the sanctioned enterprise tenant.
...
- vs. neighbors: [glean](glean.md) is the closer comparison for *internal* entitlement-aware enterprise search/RAG ([entitlement-aware-rag](../categories/entitlement-aware-rag.md)); Perplexity's connectors are newer and web-research-led. [openai-chatgpt-enterprise](openai-chatgpt-enterprise.md) and [anthropic-claude-enterprise](anthropic-claude-enterprise.md) are stronger general assistants; [microsoft-365-copilot](microsoft-365-copilot.md) / [gemini-enterprise](gemini-enterprise.md) win on native data-estate integration and residency.
...
- **Where a fund should be careful:**
  - **Comms surveillance / eDiscovery:** there is **no native archival or eDiscovery/WORM hook** for MAR/MNPI-style supervision. The audit-log webhook can stream activity to a SIEM, but that is monitoring telemetry, not a compliant comms archive. If analyst interactions need to be captured for surveillance ([comms-surveillance](../categories/comms-surveillance.md)) or legal hold, you'd have to build it off the webhook/export — flag this explicitly with Compliance.
...
- [glean](glean.md) — internal entitlement-aware enterprise search/assistant (closest on connectors).
- [openai-chatgpt-enterprise](openai-chatgpt-enterprise.md), [anthropic-claude-enterprise](anthropic-claude-enterprise.md) — stronger general assistants.
- [microsoft-365-copilot](microsoft-365-copilot.md), [gemini-enterprise](gemini-enterprise.md), [amazon-q-business](amazon-q-business.md) — data-estate-native assistants with stronger residency/compliance stories.
