...
**Where it sits in the stack** — [[content-sources]], retrieval layer (Day-1 if doing RAG). Lethal-trifecta role: **sensitive-data** leg. Needs [[entitlement-aware-rag]] and classification/DLP discipline before exposure to an assistant.
