...
**Where it sits in the stack** — Primary: [[dspm]]; also [[ai-governance-platform]] and [[data-access-governance]]. Data layer (with a foot in governance). Lethal-trifecta role: the **sensitive-data** leg (classify/constrain) plus **egress** controls around AI use of data. Trust zones: governs the data plane and the AI-governance overlay on top of it.
