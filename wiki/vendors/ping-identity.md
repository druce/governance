...
The [[identity-access]] foundation — the front door. Governs the **sensitive-data** leg of the lethal trifecta via authentication/authorization. Same Day-1 role as its IdP peers; the AI gateway and RAG layer federate to it.
