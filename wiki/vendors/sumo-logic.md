...
Foundation layer, [[siem-soc]]. Lethal-trifecta leg: **none directly** — it is the detection/audit substrate, not an inline control. It is where you'd land logs from [[ai-gateway]], [[ai-runtime-security]] and [[ai-access-governance]] tools for monitoring and forensics. Adjacent to [[ai-soc-analysts]], which increasingly sit on top of SIEM data.
...
A cloud-native SIEM/log-analytics alternative to the heavyweight incumbents. Nearest neighbors: [[splunk]] (now Cisco), [[microsoft-sentinel]], [[elastic]], [[google-secops]], [[crowdstrike-logscale]]. Sumo's pitch is SaaS-native economics and combined ops+security telemetry; it is generally positioned below Splunk/Sentinel in enterprise mindshare.
...
[[splunk]], [[microsoft-sentinel]], [[elastic]], [[google-secops]], [[crowdstrike-logscale]].
