...
> Primary category: [[enterprise-grc]]. Also tagged [[ai-governance-platform]] and [[dspm]].
...
This is a **governance-layer** play. Primary fit is [[enterprise-grc]] (the system of record for policies, risk register, assessments, and audit evidence). The AI module makes it an [[ai-governance-platform]] (use-case/model inventory, risk assessment, regulatory mapping), and its data discovery/classification capability gives it a foot in [[dspm]] (finding and classifying sensitive data at rest).
...
The tradeoff versus focused AI-governance pureplays — [[credo-ai]], [[holistic-ai]] — is depth: the pureplays go further on model-specific evaluation, bias/fairness testing, and AI-native policy intelligence, while OneTrust optimizes for fitting AI into an existing enterprise GRC operating model. Against compliance-automation tools like [[vanta]], OneTrust is heavier, broader, and aimed at large regulated enterprises rather than fast SOC 2 / security-attestation automation for smaller shops.
...
- AI-governance pureplays: [[credo-ai]], [[holistic-ai]]
- Compliance automation / attestation: [[vanta]]
- Broad GRC / privacy peers (overlap on [[enterprise-grc]] and [[dspm]])
