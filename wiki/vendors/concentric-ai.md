...
**Where it sits in the stack** — Primary: [[dspm]]; also [[data-access-governance]]. Data layer. Lethal-trifecta role: the **sensitive-data** leg — classify sensitive content and constrain who/what can access it (oversharing remediation), which directly limits what a Copilot/RAG system can surface. Trust zones: green/yellow unstructured-data plane.
...
**Competitors / alternatives** — [[cyera]], [[sentra]], [[bigid]], [[securiti]], [[microsoft-purview]], Varonis.
