...
Data layer — primary [[data-access-governance]], secondary [[dspm]]. Lethal-trifecta role: the **sensitive-data** leg — it constrains which sensitive data a human, service account, or AI/RAG pipeline can actually retrieve. Critical control for entitlement-aware analytics and [[entitlement-aware-rag]] when the warehouse is the knowledge source.
