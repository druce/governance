...
> **Category correction.** The seed registry tagged Jazz under [[ai-soc-analysts]] + [[siem-soc]]. Primary research shows Jazz is an **AI-native Data Loss Prevention (DLP)** product, not an agentic-SOC analyst. Reclassified primary to [[dlp]]. The SOC adjacency is real but narrow: its "Agentic Investigator" triages DLP alerts, not general security alerts. Soft mismatch flagged 2026-06-28.
...
**Where it sits in the stack** — [[dlp]] in the Data layer; adjacent to [[ai-access-governance]] (shadow-AI / data-into-LLM egress) and to [[data-access-governance]]. Lethal-trifecta role: it controls **sensitive-data** exposure and **egress** (data leaving to untrusted destinations). Lives at the endpoint/data boundary, the yellow-zone control point.
...
**Positioning & differentiators** — Founded 2024 in Tel Aviv by Israeli intelligence veterans; CEO/co-founder Ido Livneh. Differentiates on "AI-native, context-and-intent" DLP vs. legacy rule-based DLP. Nearest neighbors: [[cyberhaven]], [[mind]], [[nightfall-ai]], and (for the AI-egress overlap) [[prompt-security]] / [[lasso-security]].
