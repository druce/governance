...
- **AI red-teaming** ([[ai-red-teaming]]) — fold into Q4/Q5 unless surveying AI *builders*; it's a
...
- **Label acquired options with their parent** — many answer options are now product lines, not
  companies (see [[ai-security-m-and-a-map]]). A bare "Lakera" or "Portkey" dates the survey.
